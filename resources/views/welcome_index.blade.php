...
<body>
    ...
    <div class="search-bar">
        <a href="{{ route('welcome') }}"><i class="fas fa-arrow-left back-icon"></i></a>
        <form method="GET" action="{{ route('welcome.search') }}" style="display: flex; align-items: center;">
        ...
        <div class="products-grid">
            @foreach ($products as $product)
                <div class="product-item">
                    ...
                    <div class="show-produk"><a href="{{ route('welcome.show', $product->id) }}">Lihat Produk</a></div>
