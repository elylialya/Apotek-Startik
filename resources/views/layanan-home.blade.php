...
<head>
    ...
    <h1>Layanan 24x7</h1>
    <p>Tim layanan pelanggan kami siap membantu Anda 24 jam sehari, 7 hari seminggu. Jangan ragu untuk menghubungi kami jika Anda memiliki pertanyaan atau butuh bantuan.</p>
        <p>Hubungi kami di:</p>
    <ul>
    <li>Email: cintasehat@gmail.com</li><br>
        <li>Telepon: +62 853-4720-3752 (Chandra Wijaya)</li><br>
        <li>Alamat: Jalan No.2 RT. 11, Antasan Kecil Timur, Kec. Banjarmasin Utara, Kota Banjarmasin, Kalimantan Selatan 70123</li>
    </ul>
