...
<nav class="navbar">
    <div class="navbar-container">
        ...
        <ul class="navbar-menu">
            ...
            <li><a href="{{ route('welcome.search') }}">Produk</a></li>
            <li><a href="{{ route('bantuan') }}">Bantuan</a></li>
        </ul>

        <!-- Pencarian dan User Menu -->
            <div class="user-menu">
            <a href="{{ route('welcome.search') }}" class="icon">  <i class="fa fa-search"></i></i></a>
    ...
    <div class="main">
        <div class="main_tag">
            ...
            <p>
                ...
                , yang bisa memenuhi semua kebutuhan kesehatanmu. produk yang dijual di Apotek Cinta Sehat hadir dengan
                berbagai macam kategori obat pilihan untuk memenuhi seluruh kebutuhan kesehatan, mulai dari obat
                generik, obat untuk ibu dan anak, dan suplemen kesehatan
            </p>
...
<div class='category coll-3 icon-p-2'>
    ...
    <ul>
        @foreach($categories as $category)
            <li>
                <a href="{{ route('category.produk', $category->id) }}">
...
<div class="services">
    ...
    <div class="services_box">
        ...
        <!-- Penawaran terbaik -->
        <div class="services_card">
            <a href="{{ route('penawaran-terbaik') }}">
